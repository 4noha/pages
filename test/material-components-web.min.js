...
import {
  ...
  let imgSrc = key ? 'https://png-4-selfie-renderer.s3.us-west-2.amazonaws.com/'+key : null;
  if(imgSrc) setImage(imgSrc);
  
  function setImage(imgSrc) {
    imageUpload.src = imgSrc;
    imageUpload.style.display = "block";
    canvas = imageUpload.parentElement.getElementsByClassName(
      "canvas-segmentation"
    )[0];
